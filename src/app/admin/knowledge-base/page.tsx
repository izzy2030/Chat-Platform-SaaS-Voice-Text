...
export default function KnowledgeBasePage() {
  return (
    <div className="flex flex-col gap-4 p-8">
      ...
      <p className="text-lg text-muted-foreground font-medium">Train your AI models with custom documentation, FAQs, and specialized knowledge clusters.</p>
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-64 rounded-[32px] bg-muted/30 shadow-sm flex flex-col items-center justify-center p-8 text-center gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-bold text-foreground/50">Context Mapping</h3>
              <p className="text-sm text-muted-foreground/40">Integrating vector databases for semantic data retrieval.</p>
            </div>
          </div>
        ))}
      </div>
