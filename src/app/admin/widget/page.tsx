      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
          ...
          <div className="grid gap-6 px-6 py-7 lg:grid-cols-[1.2fr_0.8fr] lg:px-8">
            <div className="space-y-5">
              <div className="flex flex-wrap items-center gap-3">
                <Badge className="rounded-full border-none bg-[#ECF6E8] dark:bg-[#3b8332]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-[#2F6A29] dark:text-emerald-500 hover:bg-[#ECF6E8]">
                  Widget Studio
                </Badge>
                <Badge
                  variant="outline"
                  className="rounded-full border-[#DCE8D7] dark:border-zinc-800 bg-[#F8FBF6] dark:bg-zinc-900 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-[#677569] dark:text-zinc-400"
                >
                  Deploy & Preview
                </Badge>
              </div>
              ...
              <div className="space-y-2">
                <h1 className="max-w-3xl text-3xl font-black tracking-tight text-[#191C1D] dark:text-zinc-100 md:text-5xl">
            ...
            <div className="rounded-[28px] bg-[#1C2320] p-5 text-white shadow-[0_24px_70px_-34px_rgba(28,35,32,0.85)]">
              ...
              <Button
                ...
                className="mt-6 h-11 w-full rounded-2xl bg-white dark:bg-zinc-100 text-[#18201C] dark:text-zinc-900 hover:bg-[#F3F7F1]"
              >
        ...
        {!widgets ? (
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-72 rounded-[30px] border border-[#E5ECE1] dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/70 animate-pulse" />
            ))}
          </div>
        ) : widgets.length === 0 ? (
          <section className="rounded-[32px] border border-dashed border-[#D7E3D4] dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 p-10 text-center shadow-[0_18px_55px_-42px_rgba(24,28,29,0.32)]">
            <div className="mx-auto flex size-20 items-center justify-center rounded-[28px] bg-[#EEF6EB] dark:bg-[#3b8332]/10 text-[#3B8332] dark:text-emerald-500">
              <MessageSquare className="size-9" />
            </div>
            <div className="mx-auto mt-6 max-w-xl space-y-2">
              <h3 className="text-2xl font-black text-[#191C1D] dark:text-zinc-100">No active nodes yet</h3>
              <p className="text-sm leading-7 text-[#6A766E] dark:text-zinc-400">
          ...
          <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {widgets.map((widget, index) => (
              <article
                key={widget._id}
                className={cn(
                  'group relative flex flex-col overflow-hidden rounded-[30px] border border-[#E3EAE0] dark:border-zinc-800 bg-white/92 dark:bg-zinc-900/92 shadow-[0_20px_60px_-42px_rgba(24,28,29,0.3)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_26px_72px_-40px_rgba(24,28,29,0.38)]',
                  index % 3 === 1 && 'bg-[#F7FAF5] dark:bg-zinc-800/50'
                )}
              >
                <div className="border-b border-[#EDF2EA] dark:border-zinc-800 px-6 py-5">
                  <div className="flex items-center justify-between">
                    <div className="flex size-12 items-center justify-center rounded-[18px] bg-[#EEF6EB] dark:bg-[#3b8332]/10 text-[#3B8332] dark:text-emerald-500">
                  ...
                  <div className="mt-5 space-y-1">
                    <h3 className="truncate text-xl font-black tracking-tight text-[#191C1D] dark:text-zinc-100">
                      {widget.name}
                    </h3>
                    <p className="truncate text-sm font-medium text-[#6D7A70] dark:text-zinc-400">
                ...
                <div className="flex flex-1 flex-col px-6 py-5">
                  ...
                  <div className="mt-5 rounded-[24px] bg-[#F7FAF5] dark:bg-zinc-800/50 p-4">
                    <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#758177] dark:text-zinc-500">
                      Visitor Experience
                    </p>
                    <p className="mt-2 text-sm font-semibold leading-6 text-[#243028] dark:text-zinc-300">
                  ...
                  <div className="mt-auto flex items-center gap-2 pt-5">
                    <Button
                      variant="outline"
                      nativeButton={false}
                       className="h-10 flex-1 rounded-xl border-[#D8E3D5] dark:border-zinc-800 bg-white dark:bg-zinc-900 text-xs font-black text-[#203028] dark:text-zinc-200 hover:bg-[#EEF6EB] hover:text-[#2F6A29]"
                    ...
                    <Button
                      variant="ghost"
                      nativeButton={false}
                      className="size-10 rounded-xl bg-[#F1F5F0] dark:bg-zinc-800 p-0 text-[#536158] dark:text-zinc-400 hover:bg-[#1C2320] hover:text-white"
        ...
        <section className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[30px] border border-[#E5ECE1] dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/90 p-6 shadow-[0_18px_55px_-40px_rgba(24,28,29,0.28)]">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#738074] dark:text-zinc-500">
              Recommended Pattern
            </p>
            <h2 className="mt-2 text-2xl font-black tracking-tight text-[#191C1D] dark:text-zinc-100">
              Keep the stage calm. Let the important controls carry contrast.
            </h2>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-[#69756D] dark:text-zinc-400">
          ...
          <div className="rounded-[30px] bg-[#F7FAF5] dark:bg-zinc-800/50 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-black text-[#191C1D] dark:text-zinc-100">Dashboard, Calls, Conversations, Knowledge Base</p>
              </div>
            </div>
            <p className="mt-4 text-sm leading-7 text-[#68746C] dark:text-zinc-400">
...
function HeroPill({
  ...
  return (
    <div className="rounded-[24px] border border-[#E6EDE3] dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 p-4">
      <div className={cn('inline-flex rounded-full px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em]', tones[tone])}>
        {label}
      </div>
      <p className="mt-3 text-2xl font-black tracking-tight text-[#191C1D] dark:text-zinc-100">{value}</p>
    </div>
  );
}
...
function MiniMetric({
  ...
  return (
    <div className="rounded-[22px] border border-[#E7EEE4] dark:border-zinc-800 bg-white dark:bg-zinc-900 px-4 py-3">
      <div className="flex items-center gap-2 text-[#607064] dark:text-zinc-400">
        <Icon className="size-4" />
        <span className="text-[10px] font-black uppercase tracking-[0.18em]">{label}</span>
      </div>
      <p className="mt-2 text-sm font-black text-[#191C1D] dark:text-zinc-100">{value}</p>
    </div>
  );
}
