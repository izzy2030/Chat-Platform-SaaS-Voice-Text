          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="space-y-4">
              <div className="space-y-4 pt-2">
                <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Light Theme</h4>
              ...
              <div className="space-y-4 pt-2">
                <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Dark Theme</h4>
                <div className="flex items-center justify-between">
                  <Label>Primary Color</Label>
                  <Input
                    type="color"
                    className="w-12 h-8"
                    value={theme.darkPrimaryColor || '#6366F1'}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Input
                    type="color"
                    className="w-12 h-8"
                    value={theme.darkSecondaryColor || '#1F2937'}
                    onChange={handleColorChange('darkSecondaryColor')}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <Label>Accent Color</Label>
                  <Input
                    type="color"
                    className="w-12 h-8"
                    value={theme.darkAccentColor || '#EC4899'}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Input
                    type="color"
                    className="w-12 h-8"
                    value={theme.darkBorderColor || '#374151'}
                    onChange={handleColorChange('darkBorderColor')}
                  />
                </div>
              </div>
              <div className="space-y-2">
