...
import { useAgentAudioVisualizerAura, type AgentVisualizerState } from '@/hooks/use-agent-audio-visualizer-aura';
...
export const AgentAudioVisualizerAuraVariants = cva(['aspect-square'], {
  variants: {
    size: {
      icon: 'h-[24px] w-[24px] gap-[2px]',
      sm: 'h-[56px] w-[56px] gap-[4px]',
      md: 'h-[112px] w-[112px] gap-[8px]',
      lg: 'h-[224px] w-[224px] gap-[16px]',
      xl: 'h-[448px] w-[448px] gap-[32px]',
    },
  },
  defaultVariants: {
    size: 'md',
